...
#[link_name="glFlush"]
            pub fn Flush() -> ();
#[link_name="glFogCoordPointer"]
            pub fn FogCoordPointer(type_: types::GLenum, stride: types::GLsizei, pointer: *const __gl_imports::raw::c_void) -> ();
#[link_name="glFogCoordd"]
            pub fn FogCoordd(coord: types::GLdouble) -> ();
#[link_name="glFogCoorddv"]
            pub fn FogCoorddv(coord: *const types::GLdouble) -> ();
#[link_name="glFogCoordf"]
            pub fn FogCoordf(coord: types::GLfloat) -> ();
#[link_name="glFogCoordfv"]
            pub fn FogCoordfv(coord: *const types::GLfloat) -> ();
#[link_name="glFogf"]
...
#[link_name="glSecondaryColor3b"]
            pub fn SecondaryColor3b(red: types::GLbyte, green: types::GLbyte, blue: types::GLbyte) -> ();
#[link_name="glSecondaryColor3bv"]
            pub fn SecondaryColor3bv(v: *const types::GLbyte) -> ();
#[link_name="glSecondaryColor3d"]
            pub fn SecondaryColor3d(red: types::GLdouble, green: types::GLdouble, blue: types::GLdouble) -> ();
#[link_name="glSecondaryColor3dv"]
            pub fn SecondaryColor3dv(v: *const types::GLdouble) -> ();
#[link_name="glSecondaryColor3f"]
            pub fn SecondaryColor3f(red: types::GLfloat, green: types::GLfloat, blue: types::GLfloat) -> ();
#[link_name="glSecondaryColor3fv"]
            pub fn SecondaryColor3fv(v: *const types::GLfloat) -> ();
#[link_name="glSecondaryColor3i"]
            pub fn SecondaryColor3i(red: types::GLint, green: types::GLint, blue: types::GLint) -> ();
#[link_name="glSecondaryColor3iv"]
            pub fn SecondaryColor3iv(v: *const types::GLint) -> ();
#[link_name="glSecondaryColor3s"]
            pub fn SecondaryColor3s(red: types::GLshort, green: types::GLshort, blue: types::GLshort) -> ();
#[link_name="glSecondaryColor3sv"]
            pub fn SecondaryColor3sv(v: *const types::GLshort) -> ();
#[link_name="glSecondaryColor3ub"]
            pub fn SecondaryColor3ub(red: types::GLubyte, green: types::GLubyte, blue: types::GLubyte) -> ();
#[link_name="glSecondaryColor3ubv"]
            pub fn SecondaryColor3ubv(v: *const types::GLubyte) -> ();
#[link_name="glSecondaryColor3ui"]
            pub fn SecondaryColor3ui(red: types::GLuint, green: types::GLuint, blue: types::GLuint) -> ();
#[link_name="glSecondaryColor3uiv"]
            pub fn SecondaryColor3uiv(v: *const types::GLuint) -> ();
#[link_name="glSecondaryColor3us"]
            pub fn SecondaryColor3us(red: types::GLushort, green: types::GLushort, blue: types::GLushort) -> ();
#[link_name="glSecondaryColor3usv"]
            pub fn SecondaryColor3usv(v: *const types::GLushort) -> ();
#[link_name="glSecondaryColorPointer"]
            pub fn SecondaryColorPointer(size: types::GLint, type_: types::GLenum, stride: types::GLsizei, pointer: *const __gl_imports::raw::c_void) -> ();
...
#[link_name="glWindowPos2d"]
            pub fn WindowPos2d(x: types::GLdouble, y: types::GLdouble) -> ();
#[link_name="glWindowPos2dv"]
            pub fn WindowPos2dv(v: *const types::GLdouble) -> ();
#[link_name="glWindowPos2f"]
            pub fn WindowPos2f(x: types::GLfloat, y: types::GLfloat) -> ();
#[link_name="glWindowPos2fv"]
            pub fn WindowPos2fv(v: *const types::GLfloat) -> ();
#[link_name="glWindowPos2i"]
            pub fn WindowPos2i(x: types::GLint, y: types::GLint) -> ();
#[link_name="glWindowPos2iv"]
            pub fn WindowPos2iv(v: *const types::GLint) -> ();
#[link_name="glWindowPos2s"]
            pub fn WindowPos2s(x: types::GLshort, y: types::GLshort) -> ();
#[link_name="glWindowPos2sv"]
            pub fn WindowPos2sv(v: *const types::GLshort) -> ();
#[link_name="glWindowPos3d"]
            pub fn WindowPos3d(x: types::GLdouble, y: types::GLdouble, z: types::GLdouble) -> ();
#[link_name="glWindowPos3dv"]
            pub fn WindowPos3dv(v: *const types::GLdouble) -> ();
#[link_name="glWindowPos3f"]
            pub fn WindowPos3f(x: types::GLfloat, y: types::GLfloat, z: types::GLfloat) -> ();
#[link_name="glWindowPos3fv"]
            pub fn WindowPos3fv(v: *const types::GLfloat) -> ();
#[link_name="glWindowPos3i"]
            pub fn WindowPos3i(x: types::GLint, y: types::GLint, z: types::GLint) -> ();
#[link_name="glWindowPos3iv"]
            pub fn WindowPos3iv(v: *const types::GLint) -> ();
#[link_name="glWindowPos3s"]
            pub fn WindowPos3s(x: types::GLshort, y: types::GLshort, z: types::GLshort) -> ();
#[link_name="glWindowPos3sv"]
            pub fn WindowPos3sv(v: *const types::GLshort) -> ();
}
